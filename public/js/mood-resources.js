...
function updateMoodStatusBanner(moodKey) {
    ...
    const banner = document.getElementById('mood-status-banner');
    ...
    banner.style.background = `radial-gradient(circle at top left, ${cfg.bg} 0%, white 100%)`;
    banner.style.borderRadius = '24px';
    banner.style.border = 'none';
    icon.innerHTML = getMoodSVGForResources(normalized);
    icon.style.cssText = 'width:56px;height:56px;display:flex;align-items:center;justify-content:center;flex-shrink:0;';
